...
const Main = props => {
  ...
  return (
    <div className="mainContent">
      <h1>Main</h1>
      <div className="mainDiv">This  book  is  largely  concerned  with  Hobbits,  and  from  its
        ...
        are  nonetheless  nimble  and  deft  in  their  movements.  They possessed  from  the  first  the  art  of  disappearing  swiftly  and
        ...
        presents,  which  they  gave  away  freely  and  eagerly  accepted. </div>
    </div>
  );
}
